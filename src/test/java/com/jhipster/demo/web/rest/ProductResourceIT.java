...
import static com.jhipster.demo.domain.ProductAsserts.*;
import static com.jhipster.demo.web.rest.TestUtil.createUpdateProxyForBean;
import static com.jhipster.demo.web.rest.TestUtil.sameNumber;
...
import com.jhipster.demo.domain.Product;
import com.jhipster.demo.repository.ProductRepository;
...
class ProductResourceIT {
    ...
    public static Product createEntity() {
        return new Product().name(DEFAULT_NAME).description(DEFAULT_DESCRIPTION).price(DEFAULT_PRICE);
    }
    ...
    public static Product createUpdatedEntity() {
        return new Product().name(UPDATED_NAME).description(UPDATED_DESCRIPTION).price(UPDATED_PRICE);
    }
