...
import static com.jhipster.demo.domain.AddressAsserts.*;
...
import com.jhipster.demo.domain.Address;
import com.jhipster.demo.repository.AddressRepository;
...
class AddressResourceIT {
    ...
    public static Address createEntity() {
        return new Address().street(DEFAULT_STREET).city(DEFAULT_CITY).state(DEFAULT_STATE).zip(DEFAULT_ZIP);
    }
    ...
    public static Address createUpdatedEntity() {
        return new Address().street(UPDATED_STREET).city(UPDATED_CITY).state(UPDATED_STATE).zip(UPDATED_ZIP);
    }
    ...
    void partialUpdateAddressWithPatch() throws Exception {
        ...
        partialUpdatedAddress.street(UPDATED_STREET).city(UPDATED_CITY);
